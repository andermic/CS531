...
public class WinUNIX {
	...
	static {
		...
		try {
			BufferedReader process_out = new BufferedReader(new FileReader("config.txt"));
			String line = process_out.readLine();
			...
			System.out.println("WinUNIX: Invalid configuration: error in config.txt.");
			System.exit(1);
		}
